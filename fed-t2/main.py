...
def init_hyper(args, sam_node=None):
    ...
    if args.model == "vit":   
        ...
        if args.dataset == "cifar10":
            ...
            hnet = CNNHyper(args.n_parties, embed_dim, hidden_dim=args.hyper_hid,
                            n_hidden=args.n_hidden, n_kernels=16, out_dim=6)
...
def init_personalized_parameters(args, client_number=None):
    ...
    if args.dataset == "cifar10":
        ...
        class_num = externalconfig.K_NUM_CLASSSES
...
if __name__ == '__main__':
    ...
    if args.dataset == 'extra' :
        ...
        train_dl_global, test_dl_global, dataset_classes = get_datasets()
        # EX :
        # get_data_loaders('~/user/train','~/user/test')
        print("======================================================")
        print("資料集來源資訊 extra")
        print("======================================================")
        print(train_dl_global)
        print("======================================================")
        logger.info("len train_dl_global: %d"  %len(train_dl_global))
...
# FEDTP
        ...
        for round in range(args.comm_round):
            ...
            if args.dataset == 'shakespeare':
                local_train_net_per(nets, selected, args, train_dl_global, test_dl_global, logger, device=device)
            else: # net_dataidx_map_train ?? net_dataidx_map_test ??
            ...
            if args.dataset == "cifar10":
                ...
                num_class = externalconfig.K_NUM_CLASSSES
