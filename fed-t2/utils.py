...
def load_external_data(datadir):

    transform = transforms.Compose([transforms.ToTensor()])

    cifar10_train_ds = EXTERNAL_truncated(datadir, train=True, transform=transform)
    cifar10_test_ds = EXTERNAL_truncated(datadir, train=False, transform=transform)
    X_train, y_train = cifar10_train_ds.data, cifar10_train_ds.target # X input data
    X_test, y_test = cifar10_test_ds.data, cifar10_test_ds.target # Y output data
...
def load_cifar10_data(datadir):
    ...
    # Test
    # print("++++++++++++++++++++++++++++++++++")
    # print("cifar10_train_ds.data",cifar10_train_ds.data)
    # print(type(cifar10_train_ds.data))
    # print(len(cifar10_train_ds.data))
    # print("cifar10_train_ds.target",cifar10_train_ds.target)
    # print(type(cifar10_train_ds.target))
    # print(len(cifar10_train_ds.target))
    # print("++++++++++++++++++++++++++++++++++")
    # import sys
    # sys.exit()
    return (X_train, y_train, X_test, y_test)
...
def partition_data(dataset, datadir, partition, n_parties, beta=0.4, logdir=None):
    ...
    if dataset == 'cifar10':
        ...
        X_train, y_train, X_test, y_test = load_external_data(datadir)
        # print("=======================================")
        # print("++++++++++++++++++++++++++++++++++")
        # print("partition_data(), utils.py, 測試")
        # print("++++++++++++++++++++++++++++++++++") 
        # print("X_test, y_test")
        # print("++++++++++++++++++++++++++++++++++") 
        # print(X_test)
    ...
    if partition == "homo":
        ...
        if dataset == 'cifar10':
           # K = 10
            K = externalconfig.K_NUM_CLASSSES
        elif dataset == "cifar100":
            K = 100
        # elif dataset == 'extra':
        #     K = externalconfig.K_NUM_CLASSSES
        ...
        N_train = y_train.shape[0]
        N_test = y_test.shape[0]
        # TEST 查 net_dataidx_map_train, net_dataidx_map_test, 
        ...
        while min_size < min_require_size:
            ...
            for k in range(K):
                ...
                # 借助 numpy.random.shuffle() 方法，我們可以在numpy數組中獲得不同整數值的隨機位置，或者可以說數組中的所有值都將被隨機洗牌。
